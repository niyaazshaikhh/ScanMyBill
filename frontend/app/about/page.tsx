...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Know the developer behind ScanMyBill.in and connect on social profiles.'
};
  ...
  return (
    <main className='mx-auto min-h-screen w-full max-w-5xl px-4 py-10 sm:px-6 lg:px-8'>
      <div className='mb-6 flex items-center justify-between gap-4'>
        <div>
          ...
          <p className='mt-2 text-sm text-muted-foreground'>
            ScanMyBill.in is built to simplify invoice management and GST workflows for Indian businesses.
          </p>
        </div>
      ...
      <Card className='border-orange-200 bg-white/85'>
        <CardHeader>
          <CardTitle className='font-[var(--font-space)] text-2xl'>Developer</CardTitle>
        </CardHeader>
